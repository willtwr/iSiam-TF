...
def get_bg_images(images, exemplar_size, original_size):
  ...
  topleft = get_exemplar_images(images, exemplar_size, targets_pos=np.array([[exem_r, exem_r]]))
  topright = get_exemplar_images(images, exemplar_size, targets_pos=np.array([[exem_r, x_width - exem_r - 1]]))
  bottomleft = get_exemplar_images(images, exemplar_size, targets_pos=np.array([[x_height - exem_r - 1, exem_r]]))
  bottomright = get_exemplar_images(images, exemplar_size, targets_pos=np.array([[x_height - exem_r - 1, x_width - exem_r - 1]]))
