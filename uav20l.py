...
from inference import inference_wrapper_uav20l as inference_wrapper
from inference.tracker_nl_uav20l import ISiamTrackerTF
...
class ISiamTracker(Tracker):
    ...
    def init(self, image, box):
        ...
        im = np.array(image)
        self.dir_name = os.path.join('/home/william/uav123_benchmark/results/samples20l', vid)
...
if __name__ == '__main__':
    ...
    # run experiments
    experiment = ExperimentUAV123('/home/william/dataset/uav123/UAV123', version='UAV20L')
